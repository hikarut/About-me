...
* デジタルマーケティング領域における戦略立案、KPI設計、施策のプランニング、施策の実行、分析を1人で実現できるスキル
* フロントエンド、サーバサイド、バックエンドなどフルスタックでWebサービスを企画、設計、開発、運用ができるエンジニアリング経験
...
###### できる
SQL / アクセス解析 / 顧客分析 / KPI設計 / UI・UX改善 / Python / Jupyter Notebook / Tableau / Power BI / Google Analytics / Google Data Studio / 
...
|年|会社|内容|
|---|-----|---|
|2020年4月〜2023年6月|茨城ロボッツ|・マーケティングストラテジストとしてのデータ分析<br>・チケット購買データ分析<br>・来場者アンケート分析など|
|2020年11月〜2023年6月|LAPRAS株式会社|・エンジニアスカウトサポート業務で100名以上のエンジニアのGitHubやQiita等のアウトプットを確認して採用のサポート<br>・SQLやBIツールを使った社内のデータ分析業務のサポート<br>・SQLの研修やデータ分析業務改善コンサル|
|2017年4月〜2020年2月|株式会社エッグシステム|・Webエンジニアとしてサービスの開発/企画/ディレクション<br>・開発から複業/副業メンバーのマネジメントやコードレビュー<br>・セミナー講師<br>・データ分析|

#### コミュニティ
|年|会社|内容|
|---|-----|---|
|2018年4月〜2021年3月|ソフトバンク|ソフトバンクアカデミア 8期生|
|2017年4月〜2018年3月|Yahoo! JAPAN|ヤフーアカデミア選抜クラス|


## イベント・セミナー登壇
|日付|イベント|発表内容|
|---|-----|---|
|2023年5月|[第17回 意思決定のためのデータ分析勉強会 〜ChatGPT活用特集・Hybrid開催〜](https://ishikettei.connpass.com/event/281117/)|[SQLを活用したデータ分析におけるChatGPTの活用法](https://speakerdeck.com/hikarut/sqlwohuo-yong-sitadetafen-xi-niokeruchatgptnohuo-yong-fa)|
